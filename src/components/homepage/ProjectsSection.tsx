...
const ProjectsSection: NextComponentType = () => {
  return (
    <div className="bg-zinc-900">
      <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px-8 lg:py-24 text-white">
                    ...
                    <div className="sm:col-span-2">
                      <div className="space-y-4">
                        <div className="text-lg leading-6 font-medium space-y-1">
                          <h3>{project.name}</h3>
                          <p className="text-yellow-600">{project.role}</p>
                        </div>
                        <div className="text-lg">
                          <p className="text-gray-500">{project.bio}</p>
                        </div>
